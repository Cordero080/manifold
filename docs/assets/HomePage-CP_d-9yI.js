import{j as t,r as c,M as ue,O as De,B as oe,F as ve,S as ee,U as ge,V as G,W as ne,H as le,N as Le,C as ze,a as z,b as J,A as re,c as xe,d as ye,e as be,P as He,f as $e,g as Ue,E as we,L as Se,h as Me,i as ke,k as Oe,l as qe,m as je,n as Te,o as Re,u as Ie,p as Ve}from"./index-CW1nex6p.js";import{Q as Ge}from"./QuantumNav-DfD1pP8s.js";import{h as Z}from"./HomeIndex.module-RBK1a2id.js";import{p as fe,g as de}from"./portalWorlds-C3rb6Bz6.js";import{B as me}from"./BeamScanButton-CdX9GS_7.js";const Qe="_quoteHighlight_1kgkr_4",We={quoteHighlight:Qe};function Ye(){return t.jsxs("div",{className:We.quoteHighlight,children:['"The universe is a terrifyingly elegant apparatus, built on the immutable laws of the machine, yet the joy and the agony of this existence are all contained within the subjective, anxious leap of self-creation . We find that the objective reality of the cosmos is, in its essence, the consciousness of a dream.Therefore, abandon the illusion of a separate self and simply be in this brief, defiant affirmation of the present moment."',t.jsx("br",{})]})}function Ke(h,e){return Array.from({length:e},()=>Array.from({length:h},()=>Math.random()>.8?1:0))}function Xe(h){const e=h.length,a=h[0].length,r=h.map(i=>i.slice());for(let i=0;i<e;i++)for(let s=0;s<a;s++){let o=0;for(let f=-1;f<=1;f++)for(let n=-1;n<=1;n++){if(f===0&&n===0)continue;const d=(i+f+e)%e,w=(s+n+a)%a;o+=h[d][w]}h[i][s]===1?r[i][s]=o===2||o===3?1:0:r[i][s]=o===3?1:0}return r}function Ze({portalState:h,onQuantumCollapse:e}){const a=c.useRef(),[r,i]=c.useState({progress:0,atBottom:!1}),[s,o]=c.useState(0),[f,n]=c.useState(0),[d,w]=c.useState(()=>Ke(60,24));c.useEffect(()=>{const v=setInterval(()=>{w(x=>Xe(x))},100);return()=>clearInterval(v)},[]),c.useEffect(()=>{let v;const x=()=>{n(Date.now()/1e3),v=requestAnimationFrame(x)};return x(),()=>cancelAnimationFrame(v)},[]);function M(v){const x=v.target.getBoundingClientRect(),R=Math.floor((v.clientX-x.left)/x.width*d[0].length),N=Math.floor((v.clientY-x.top)/x.height*d.length);w(P=>{const O=P.map(l=>l.slice());for(let l=-1;l<=1;l++)for(let $=-1;$<=1;$++){const U=(R+$+O[0].length)%O[0].length,u=(N+l+O.length)%O.length;O[u][U]=1}return O})}const p=[{className:"parallax-bg",style:v=>({transform:`translateY(${-v*60}px) scale(1.1)`,opacity:1,zIndex:0,position:"absolute",left:0,right:0,top:0,bottom:0,pointerEvents:"none",background:"radial-gradient(ellipse at 60% 60%, #0a0f1a 60%, #000 100%)",overflow:"hidden"}),content:t.jsxs("svg",{width:"100%",height:"100%",style:{position:"absolute",left:0,top:0,zIndex:0,cursor:"none"},onClick:M,children:[t.jsxs("defs",{children:[t.jsxs("linearGradient",{id:"cell-grad-1",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[t.jsx("stop",{offset:"0%",stopColor:h.colors[0],stopOpacity:"0.9"}),t.jsx("stop",{offset:"100%",stopColor:h.colors[1],stopOpacity:"0.6"})]}),t.jsxs("linearGradient",{id:"cell-grad-2",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[t.jsx("stop",{offset:"0%",stopColor:h.colors[1],stopOpacity:"0.8"}),t.jsx("stop",{offset:"100%",stopColor:h.colors[2],stopOpacity:"0.5"})]}),t.jsxs("linearGradient",{id:"cell-grad-3",x1:"100%",y1:"0%",x2:"0%",y2:"100%",children:[t.jsx("stop",{offset:"0%",stopColor:h.colors[2],stopOpacity:"0.7"}),t.jsx("stop",{offset:"100%",stopColor:h.colors[0],stopOpacity:"0.4"})]}),t.jsxs("filter",{id:"cell-glow",children:[t.jsx("feGaussianBlur",{stdDeviation:"2",result:"coloredBlur"}),t.jsxs("feMerge",{children:[t.jsx("feMergeNode",{in:"coloredBlur"}),t.jsx("feMergeNode",{in:"SourceGraphic"})]})]})]}),d.map((v,x)=>v.map((R,N)=>{if(!R)return null;const O=`cell-grad-${(N+x)%3+1}`,l=2.15+.25*Math.sin(f+N*.2+x*.3),$=N/d[0].length*100,U=x/d.length*100,u=5/d[0].length*100,A=.1/d.length*100;return t.jsx("rect",{x:$+"%",y:U+"%",width:u+"%",height:A+"%",fill:`url(#${O})`,opacity:l,filter:"url(#cell-glow)",rx:"0.3",children:t.jsx("animate",{attributeName:"opacity",values:`${l};${l*1.5};${l}`,dur:"2s",repeatCount:"indefinite"})},N+"-"+x)}))]})}];c.useEffect(()=>{const v=()=>{if(!a.current)return;const x=a.current.getBoundingClientRect(),R=window.innerHeight;let N=1-Math.max(0,Math.min(1,x.bottom/R));N=Math.max(0,Math.min(1,N));const P=window.innerHeight+window.scrollY>=document.body.offsetHeight-2;i({progress:N,atBottom:P})};return window.addEventListener("scroll",v),v(),()=>window.removeEventListener("scroll",v)},[]),c.useEffect(()=>{let v;const x=()=>{o(Math.sin(Date.now()/600)),v=requestAnimationFrame(x)};return x(),()=>cancelAnimationFrame(v)},[]);const{progress:g,atBottom:m}=r,b=20.5+20.5*s,B=m?1:.15+b*.5*g+3.35*g,j=m?0:22+88*(1-b)*g,T=m?"#00fff7af":`rgba(0,255,247,${.5+.5*g})`,y=`blur(${j}px) brightness(${1+g*1.2}) saturate(${1.2+g*1.3})`,C=m?"translateY(60px)":`translateY(${-40*(1-g)}px) scale(${1+g*.7+b*.1}) skewY(${-6*g}deg)`;return t.jsxs("section",{style:{marginTop:"60px",marginBottom:"40px",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",position:"relative",minHeight:"120px",overflow:"hidden"},children:[p.map((v,x)=>t.jsx("div",{className:v.className,style:v.style(g),children:v.content},v.className)),t.jsx("div",{className:"progress-bar",style:{marginBottom:"50px",width:"auto",position:"relative",zIndex:3},children:t.jsx("div",{ref:a,className:"floating-code parallax-holo",style:{opacity:B,filter:y,transform:C,color:T,fontSize:m?"2em":"2.25em",transition:m?"all 0.7s cubic-bezier(0.4,0,0.2,1)":"transform 1.2s cubic-bezier(0.4,0,0.2,1), opacity 1.2s, filter 1.2s, color 1.2s",willChange:"transform, opacity, filter, color",mixBlendMode:m?"normal":"screen",fontFamily:"'Orbitron', 'Rajdhani', monospace"}})})]})}function Je({id:h,isActive:e,backgroundClass:a,children:r,animation:i}){return t.jsxs("section",{className:`quantum-scene${e?" active":""}`,id:h,children:[i,t.jsx("div",{className:`scene-background ${a}`}),t.jsx("div",{className:"scene-content",children:r})]})}function et({originalText:h,finalText:e,delay:a=3e3}){const[r,i]=c.useState(h),[s,o]=c.useState(!1),f=c.useRef(null),n=c.useRef(null),d=["ア","イ","ウ","エ","オ","カ","キ","ク","ケ","コ","サ","シ","ス","セ","ソ","タ","チ","ツ","テ","ト","ナ","ニ","ヌ","ネ","ノ","ハ","ヒ","フ","ヘ","ホ","マ","ミ","ム","メ","モ","ヤ","ユ","ヨ","ラ","リ","ル","レ","ロ","ワ","ヲ","ン"];return c.useEffect(()=>(s?f.current=setTimeout(()=>{const M=e.split(""),p=new Array(M.length).fill(!1),g=Date.now(),m=2e3/M.length;let b=50;n.current=setInterval(()=>{const B=Date.now()-g,j=B/2e3;b=Math.max(10,50-j*40),M.forEach((y,C)=>{B>m*(C+1)&&(p[C]=!0)});const T=M.map((y,C)=>p[C]?y:d[Math.floor(Math.random()*d.length)]).join("");i(T),B>=2e3&&(i(e),clearInterval(n.current))},b)},a):(f.current&&clearTimeout(f.current),n.current&&clearInterval(n.current),i(h)),()=>{f.current&&clearTimeout(f.current),n.current&&clearInterval(n.current)}),[s,h,e,a]),t.jsx("span",{onMouseEnter:()=>o(!0),onMouseLeave:()=>o(!1),className:"scramble-hover-span",children:r})}const ce={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
    ...
    `,g=new ee({uniforms:w,vertexShader:M,fragmentShader:p,transparent:!0,blending:re,depthWrite:!1}),m=new He(2,2),b=new ue(m,g);s.add(b),r.current={scene:s,camera:o,renderer:f,mesh:b,composer:n,bloomPass:d};let B;const j=()=>{i.current.time.value+=.01,n.render(),B=requestAnimationFrame(j)};j();const T=()=>{const y=window.innerWidth,C=window.innerHeight;f.setSize(y,C),n.setSize(y,C),i.current.resolution.value.set(y,C)};return window.addEventListener("resize",T),()=>{cancelAnimationFrame(B),window.removeEventListener("resize",T),m.dispose(),g.dispose(),f.dispose()}},[]),c.useEffect(()=>{i.current&&(i.current.color1.value.set(e.color1),i.current.color2.value.set(e.color2),i.current.color3.value.set(e.color3))},[e]),t.jsx("canvas",{ref:a,className:`${pe.quantumCanvas} ${h==="bottom"?pe.quantumCanvasBottom:h==="middle"?pe.quantumCanvasMiddle:""}`,"aria-hidden":"true"})};function ft({portalState:h,bgRef:e,fgRef:a}){const[r,i]=c.useState(h.colors),[s,o]=c.useState(h.colors),f=c.useRef(null);return c.useEffect(()=>{o(h.colors);const n=Date.now(),d=800,w=[...r],M=()=>{const p=Date.now()-n,g=Math.min(p/d,1),m=g<.5?2*g*g:-1+(4-2*g)*g,b=w.map((B,j)=>{const T=h.colors[j],y=_e(B),C=_e(T),v=Math.round(y.r+(C.r-y.r)*m),x=Math.round(y.g+(C.g-y.g)*m),R=Math.round(y.b+(C.b-y.b)*m);return dt(v,x,R)});i(b),g<1&&(f.current=requestAnimationFrame(M))};return f.current&&cancelAnimationFrame(f.current),f.current=requestAnimationFrame(M),()=>{f.current&&cancelAnimationFrame(f.current)}},[h.colors]),t.jsxs(t.Fragment,{children:[t.jsx(Ee,{position:"top",sceneColors:{color1:r[0],color2:r[1],color3:r[2]}}),t.jsx(Ee,{position:"bottom",sceneColors:{color1:r[0],color2:r[1],color3:r[2]}}),t.jsx("div",{className:Z.baseDark}),t.jsx("div",{className:Z.quantumPortalLayer,style:{"--portal-color-0":r[0],"--portal-color-1":r[1],"--portal-color-2":r[2]}}),t.jsx("div",{className:Z.quantumVeil}),t.jsx("div",{className:Z.darkTopVeil}),t.jsx("div",{className:"dynamic-portal-bg","aria-hidden":"true",children:t.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 1920 1080",className:"portal-svg",style:{"--portal-svg-background":`linear-gradient(120deg, 
              ${r[0]} 0%, 
              ${r[1]} 60%, 
              ${r[2]} 100%
            )`},children:[t.jsx("defs",{children:t.jsxs("linearGradient",{id:"portal-glow",x1:"0",y1:"0",x2:"1",y2:"1",children:[t.jsx("stop",{offset:"0%",stopColor:r[0],stopOpacity:"0.6"}),t.jsx("stop",{offset:"50%",stopColor:r[1],stopOpacity:"0.4"}),t.jsx("stop",{offset:"100%",stopColor:r[2],stopOpacity:"0.6"})]})}),t.jsx("rect",{x:"0",y:"0",width:"1920",height:"1080",fill:"url(#portal-glow)"})]})}),t.jsx("div",{ref:e,className:Z.parallaxBgLayer,"aria-hidden":"true",children:t.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 1920 400",children:[t.jsx("defs",{children:t.jsxs("linearGradient",{id:"homepage-parallax-bg-grad",x1:"0",y1:"0",x2:"1",y2:"1",children:[t.jsx("stop",{offset:"0%",stopColor:"#000000",stopOpacity:"1"}),t.jsx("stop",{offset:"100%",stopColor:"#0a0f1a",stopOpacity:"1"})]})}),t.jsx("rect",{x:"0",y:"0",width:"1920",height:"400",fill:"url(#homepage-parallax-bg-grad)"})]})}),t.jsx("div",{ref:a,className:Z.parallaxFgLayer,"aria-hidden":"true",children:t.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 1920 400",children:[t.jsx("defs",{children:t.jsxs("linearGradient",{id:"homepage-parallax-fg-grad",x1:"0",y1:"0",x2:"1",y2:"1",children:[t.jsx("stop",{offset:"0%",stopColor:"#000000",stopOpacity:"1"}),t.jsx("stop",{offset:"100%",stopColor:"#0a0f1a",stopOpacity:"1"})]})}),t.jsx("rect",{x:"0",y:"0",width:"1920",height:"400",fill:"url(#homepage-parallax-fg-grad)"})]})})]})}function _e(h){const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(h);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:{r:0,g:0,b:0}}function dt(h,e,a){return"#"+((1<<24)+(h<<16)+(e<<8)+a).toString(16).slice(1)}function mt({isActive:h=!1}){const e=c.useRef(),a=c.useRef(),r=c.useRef(),i=c.useRef(),s=c.useRef(),o=c.useRef(),f=c.useRef(),n=c.useRef([]),d=c.useRef([]),w=c.useRef(0),M=c.useRef(new Map);return c.useEffect(()=>{if(!e.current)return;const p=new ye;a.current=p;const g=new $e(1e3,e.current.clientWidth/e.current.clientHeight,.1,10);g.position.z=3,i.current=g;const m=new be({alpha:!0,antialias:!0});m.setSize(e.current.clientWidth,e.current.clientHeight),m.setClearColor(0,0),e.current.appendChild(m.domElement),r.current=m;const b=()=>{if(!e.current)return;const l=e.current.clientWidth,$=e.current.clientHeight;g.aspect=l/$,g.updateProjectionMatrix(),m.setSize(l,$)};window.addEventListener("resize",b);const B=Ue(),j=new we(B),T=j.attributes.position.array,y=[];for(let l=0;l<T.length;l+=6){const $=new J(T[l],T[l+1],T[l+2]),U=new J(T[l+3],T[l+4],T[l+5]),u=new oe().setFromPoints([$,U]),A=new Se({color:65338,transparent:!0,opacity:.15}),E=new Me(u,A),H=`${$.x.toFixed(6)},${$.y.toFixed(6)},${$.z.toFixed(6)}`,D=`${U.x.toFixed(6)},${U.y.toFixed(6)},${U.z.toFixed(6)}`,Y=[H,D].sort().join("|");E.userData.edgeKey=Y,E.userData.baseColor=65338,E.userData.baseOpacity=.15,p.add(E),y.push(E)}s.current={rotation:new ke,edgeSegments:y};const C=B.attributes.position.array,v=new oe;v.setAttribute("position",new ve(C,3));const x=new Oe({color:65338,size:.01,transparent:!0,opacity:.6,blending:re}),R=new qe(v,x);p.add(R),f.current=R;const N=new Map,P=j.attributes.position.array;for(let l=0;l<P.length;l+=6){const $=`${P[l]},${P[l+1]},${P[l+2]}`,U=`${P[l+3]},${P[l+4]},${P[l+5]}`;N.has($)||N.set($,[]),N.has(U)||N.set(U,[]),N.get($).push([P[l+3],P[l+4],P[l+5]]),N.get(U).push([P[l],P[l+1],P[l+2]])}function O(){if(o.current=requestAnimationFrame(O),s.current){if(s.current.rotation.x+=1e-4,s.current.rotation.y+=9e-4,s.current.rotation.z+=.003,s.current.edgeSegments.forEach(u=>{u.rotation.copy(s.current.rotation)}),f.current.rotation.copy(s.current.rotation),w.current+=.016,w.current>7+Math.random()*3){const u=C.length/3,A=Math.floor(Math.random()*u)*3,E=[C[A],C[A+1],C[A+2]];n.current.forEach(I=>p.remove(I)),d.current.forEach(I=>p.remove(I)),n.current=[],d.current=[];const H=Math.random(),D=[new J(E[0],E[1],E[2])],Y=[`${E[0]},${E[1]},${E[2]}`];let k=E,Q=null;const Ce=50+Math.floor(Math.random()*20);for(let I=0;I<Ce;I++){const S=`${k[0]},${k[1]},${k[2]}`,_=N.get(S)||[];if(_.length===0)break;let L=_;if(Q){const W=`${Q[0]},${Q[1]},${Q[2]}`;L=_.filter(V=>`${V[0]},${V[1]},${V[2]}`!==W)}L.length===0&&(L=_);const F=L[Math.floor(Math.random()*L.length)];D.push(new J(F[0],F[1],F[2])),Y.push(`${F[0]},${F[1]},${F[2]}`),Q=k,k=F}const he={path:D,pathVertexKeys:Y,hue:H,startTime:Date.now(),duration:3.78,illuminatedNodes:[]},te=new Se({color:new z().setHSL(H,1,.7),transparent:!0,opacity:0,blending:re,linewidth:5}),K=new oe,X=new Me(K,te);X.userData=he,p.add(X),d.current.push(X),w.current=0}const l=Date.now();d.current.forEach(u=>{const A=(l-u.userData.startTime)/1e3,E=u.userData.duration||3.78;if(A>E+.3)p.remove(u);else if(A<=E){const H=Math.min(A/E,1),D=u.userData.path||[];if(u.userData.pathVertexKeys,D.length<2)return;let Y=0;const k=[];for(let S=0;S<D.length-1;S++){const _=D[S].distanceTo(D[S+1]);k.push(_),Y+=_}const Q=H*Y,he=Y*.4,te=Math.max(0,Q-he),K=[];let X=0;for(let S=0;S<D.length-1;S++){const _=X,L=X+k[S];if(L>=te&&_<=Q){const F=Math.max(0,(te-_)/k[S]),W=Math.min(1,(Q-_)/k[S]),V=D[S].clone().lerp(D[S+1],F),q=D[S].clone().lerp(D[S+1],W);(K.length===0||!K[K.length-1].equals(V))&&K.push(V),K.push(q)}X=L}const I=u.userData.illuminatedNodes||[];X=0;for(let S=0;S<k.length;S++)if(X+=k[S],te>X&&!I[S+1]){const _=D[S+1],L=new je(.012,8,8),F=new xe({color:65338,transparent:!0,opacity:.5,blending:re}),W=new ue(L,F);if(W.position.copy(_),W.userData={createdAt:l},p.add(W),n.current.push(W),I[S+1]=W,S<D.length-1){const V=D[S],q=D[S+1],Be=`${V.x.toFixed(6)},${V.y.toFixed(6)},${V.z.toFixed(6)}`,Ae=`${q.x.toFixed(6)},${q.y.toFixed(6)},${q.z.toFixed(6)}`,Fe=[Be,Ae].sort().join("|");M.current.set(Fe,{hue:u.userData.hue,timestamp:l,intensity:1})}}if(te>0&&!I[0]){const S=D[0],_=new je(.012,8,8),L=new xe({color:65338,transparent:!0,opacity:.7,blending:re}),F=new ue(_,L);F.position.copy(S),F.userData={createdAt:l},p.add(F),n.current.push(F),I[0]=F}if(u.userData.illuminatedNodes=I,K.length>1){u.geometry.setFromPoints(K);const S=Math.min(H*2,1);u.material.opacity=.9*S}else K.length===1&&u.geometry.setFromPoints([]);if(H>=.99&&s.current&&s.current.edgeSegments&&!u.userData.colorChanged&&(u.userData.colorChanged=!0,u.userData.flashStartTime=l,u.userData.targetHue=u.userData.hue),u.userData.colorChanged&&u.userData.flashStartTime&&s.current&&s.current.edgeSegments){const S=(l-u.userData.flashStartTime)/1e3;if(S<.02){const _=S/.06;let L;if(_<.01)L=_/.2;else{const q=(_-.2)/.7;L=Math.exp(-q*9)}const F=.6+.4*L,W=.35+.55*L,V=.2+.5*L;s.current.edgeSegments.forEach(q=>{q.material&&q.material.color&&(q.material.color.setHSL(u.userData.targetHue,F,W),q.material.opacity=V)})}else s.current.edgeSegments.forEach(_=>{_.material&&_.material.color&&(_.material.color.setHSL(u.userData.targetHue,.6,.35),_.material.opacity=.2)}),u.userData.flashStartTime=null}}else{const H=(A-E)/.5;u.material.opacity=.9*(1-H),H>=1&&u.geometry.setFromPoints([])}}),n.current.forEach(u=>{const A=(l-u.userData.createdAt)/100;if(A>4)p.remove(u);else{const E=Math.max(0,1-A/4);u.material.opacity=.9*E;const H=Math.sin(A*8)*.15+1;u.scale.setScalar(H)}}),n.current=n.current.filter(u=>u.parent),d.current=d.current.filter(u=>u.parent);const $=8e3,U=[];s.current.edgeSegments.forEach(u=>{const A=u.userData.edgeKey,E=M.current.get(A);if(E){const H=l-E.timestamp;if(H>$)u.material.color.setHex(u.userData.baseColor),u.material.opacity=u.userData.baseOpacity,U.push(A);else{const D=H/$,Y=new z().setHSL(E.hue,.8,.5),k=new z(u.userData.baseColor);u.material.color.copy(Y).lerp(k,D);const Q=.7;u.material.opacity=Q*(1-D)+u.userData.baseOpacity*D}}else u.material.color.setHex(u.userData.baseColor),u.material.opacity=u.userData.baseOpacity}),U.forEach(u=>M.current.delete(u))}m.render(p,g)}return O(),()=>{window.removeEventListener("resize",b),o.current&&cancelAnimationFrame(o.current),r.current&&e.current&&e.current.removeChild(r.current.domElement),n.current.forEach(l=>{l.geometry&&l.geometry.dispose(),l.material&&l.material.dispose()}),d.current.forEach(l=>{l.geometry&&l.geometry.dispose(),l.material&&l.material.dispose()}),s.current&&s.current.edgeSegments&&s.current.edgeSegments.forEach(l=>{l.geometry&&l.geometry.dispose(),l.material&&l.material.dispose()}),B.dispose(),j.dispose(),v.dispose(),x.dispose(),m.dispose()}},[]),t.jsx("div",{ref:e,style:{width:"100%",height:"100%",position:"absolute",top:"-5%",left:"50%",transform:"translateX(-50%)",zIndex:1,pointerEvents:"none",maskImage:"linear-gradient(to bottom, white 0%, white 60%, transparent 90%)",WebkitMaskImage:"linear-gradient(to bottom, white 0%, white 60%, transparent 90%)"}})}function pt({isActive:h=!1}){const e=c.useRef(),a=c.useRef(),r=c.useRef(),i=c.useRef(),s=c.useRef(),o=c.useRef(),f=c.useRef(),n=c.useRef(0);return c.useEffect(()=>{if(!e.current)return;const d=new ye;a.current=d;const w=new $e(65,e.current.clientWidth/e.current.clientHeight,.1,1e3);w.position.z=4,i.current=w;const M=new be({alpha:!0,antialias:!0});M.setSize(e.current.clientWidth,e.current.clientHeight),M.setClearColor(0,0),e.current.appendChild(M.domElement),r.current=M;const p=()=>{if(!e.current)return;const x=e.current.clientWidth,R=e.current.clientHeight;w.aspect=x/R,w.updateProjectionMatrix(),M.setSize(x,R)};window.addEventListener("resize",p);const g=Te(),m=new we(g),b=new ee({transparent:!0,opacity:.65,uniforms:{time:{value:0},color1:{value:new z(11141375)},color2:{value:new z(65535)},color3:{value:new z(16711850)},opacity:{value:.65}},vertexShader:`
      ...
      `}),B=new Re(m,b);d.add(B),s.current=B;const j=Te({scale:.35}),T=new we(j),y=new ee({transparent:!0,uniforms:{time:{value:0},color1:{value:new z(16738047)},color2:{value:new z(14518527)},color3:{value:new z(16755455)},color4:{value:new z(6750207)},opacity:{value:.25}},vertexShader:`
        void main() {
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        }
      `,fragmentShader:`
